...
1. Download the zip file from [Release](https://github.com/Delsin-Yu/GD-AtlasTexture-Creator/releases/download/0.1.0/GD-AtlasTexture-Creator.0.1.0.zip).
...
1. 从[Release](https://github.com/Delsin-Yu/GD-AtlasTexture-Creator/releases/download/0.1.0/GD-AtlasTexture-Creator.0.1.0.zip)处下载压缩包。
